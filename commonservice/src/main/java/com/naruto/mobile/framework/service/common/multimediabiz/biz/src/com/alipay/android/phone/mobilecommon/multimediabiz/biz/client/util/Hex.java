...
public class Hex {
    ...
    /**
     * Default charset name is {@link com.naruto.android.phone.mobilecommon.multimediabiz.biz.client.io.Charsets#UTF_8}
     *
     * @since 1.7
     */
    ...
    public byte[] encode(final byte[] array)throws UnsupportedEncodingException{
        return encodeHexString(array).getBytes(this.getCharsetName());
    }
    ...
    public Object encode(final Object object) throws Exception {
        try {
            final byte[] byteArray = object instanceof String ?
                                   ((String) object).getBytes(this.getCharsetName()) : (byte[]) object;
