...
package com.naruto.mobile.framework.service.common.multimediabiz.biz.src.tv.danmaku.ijk.media.player;
...
//    }
     ...
     */
    @Override
    public void setDataSource(String path, boolean disableAudio) throws IOException,
        ...
        _setDataSource(path, audioDisable, null, null);
    }

    private native void _setDataSource(String path, int disableAudio, String[] keys,
    ...
    public native void drawThumb(byte[] data, int size);
...
//    }
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_BUFFERING_UPDATE:
                ...
                // Log.efmt(TAG, "Buffer (%d%%) %d/%d",  percent, bufferPosition, duration);
    ...
    private static int onControlResolveSegmentCount(Object weakThiz) {
        Log.i(TAG, "onControlResolveSegmentCount");
    ...
    private static String onControlResolveSegmentUrl(Object weakThiz, int segment) {
        Log.i(TAG, "onControlResolveSegmentUrl" + segment);
        if (weakThiz == null || !(weakThiz instanceof WeakReference<?>))
            return null;
    ...
    private static String onControlResolveSegmentOfflineMrl(Object weakThiz, int segment) {
        Log.i(TAG, "onControlResolveSegmentOfflineMrl " + segment);
        if (weakThiz == null || !(weakThiz instanceof WeakReference<?>))
            return null;
    ...
    private static int onControlResolveSegmentDuration(Object weakThiz, int segment) {
        Log.i(TAG, "onControlResolveSegmentDuration" + segment);
        if (weakThiz == null || !(weakThiz instanceof WeakReference<?>))
            return -1;
