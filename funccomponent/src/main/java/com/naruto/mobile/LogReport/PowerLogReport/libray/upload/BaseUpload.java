 ...
 */
package com.naruto.mobile.LogReport.PowerLogReport.libray.upload;
...
public abstract class BaseUpload implements ILogUpload {
    ...
    public String buildTitle(Context context) {
        return "【CrashLog】  " + context.getString(context.getApplicationInfo().labelRes) + " " + yyyy_MM_dd_HH_mm_ss_SS.format(
