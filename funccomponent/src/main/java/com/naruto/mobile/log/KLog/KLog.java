package com.naruto.mobile.log.KLog;
...
import com.naruto.mobile.log.KLog.klog.BaseLog;
import com.naruto.mobile.log.KLog.klog.FileLog;
import com.naruto.mobile.log.KLog.klog.JsonLog;
import com.naruto.mobile.log.KLog.klog.XmlLog;
...
public final class KLog {
    ...
    public static final String LINE_SEPARATOR = System.getProperty("line.separator");//行间隔符
    ...
    public static final int JSON_INDENT = 4;//空格数
    ...
    private static boolean IS_SHOW_LOG = true;//是否打印log标记

    /**
     * 是否打印log，在application中调用，
     * @param isShowLog
     */
    ...
    public static void debug() {
        printDebug(null, DEFAULT_MESSAGE);//第一个参数为tag，第二个参数为msg
    }
    ...
    private static void printStackTrace() {
        ...
        /**
         * java.lang.Throwable
         at com.socks.library.KLog.printStackTrace(KLog.java:199)
         at com.socks.library.KLog.trace(KLog.java:190)
         at com.socks.sample.TestTraceUtil.testTrace(TestTraceUtil.java:12)
         at com.socks.sample.MainActivity.logTraceStack(MainActivity.java:67)
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        ...
        StackTraceElement targetElement = stackTrace[stackTraceIndex];//stackTrace[5] eg:com.socks.sample.MainActivity.logDebug(MainActivity.java:71)
        String className = targetElement.getClassName();//com.socks.sample.MainActivity
        String[] classNameInfo = className.split("\\.");
        if (classNameInfo.length > 0) {
            className = classNameInfo[classNameInfo.length - 1] + SUFFIX;//MainActivity.java
        }
        ...
        String methodName = targetElement.getMethodName();//logDebug
        int lineNumber = targetElement.getLineNumber();//拿到行号
        ...
        String headString = "[ (" + className + ":" + lineNumber + ")#" + methodName + " ] ";//[ (KLog.java:195)#trace ]
