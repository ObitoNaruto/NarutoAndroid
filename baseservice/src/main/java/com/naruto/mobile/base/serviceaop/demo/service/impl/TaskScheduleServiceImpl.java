...
import com.naruto.mobile.base.threadpool.CommonThreadFactory;
import com.naruto.mobile.base.threadpool.LifoBlockingDeque;
import com.naruto.mobile.base.threadpool.OrderedExecutor;
import com.naruto.mobile.base.threadpool.PipeLine;
import com.naruto.mobile.base.threadpool.ProcessCpuTracker;
import com.naruto.mobile.base.threadpool.ScheduledTaskPoolExecutor;
import com.naruto.mobile.base.threadpool.TaskPoolExecutor;
...
//            throw new IllegalArgumentException("new task won't be accepted after all Pipeline being executed!");
        ...
        NarutoApplicationContext microApp = NarutoApplication.getInstance().getNarutoApplicationContext();
        if (microApp == null) {
