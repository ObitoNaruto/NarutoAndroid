...
public class BinderPoolManager {
    ...
    private synchronized void connectBinderPoolService() {
        ...
        try {
            mConnectBinderPoolCountDownLatch.await();//CountDownLatch将bindService这一异步操作转换成了同步操作
    ...
    private ServiceConnection mBinderPoolConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            try {
                mBinderPool.asBinder().linkToDeath(mBinderPoolDeathRecipient, 0);//给Binder设置DeathRecipient监听，
            } catch (RemoteException e) {
                e.printStackTrace();
            }
    ...
    //当Binder死亡时，我们会收到binderDied方法的回调，在binderDied中我我们可以重启远程服务
