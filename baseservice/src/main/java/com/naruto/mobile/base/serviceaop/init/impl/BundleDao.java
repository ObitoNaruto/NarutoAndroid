...
//    }
    ...
    public List<Bundle> getBundles() {
        List<Bundle> bundleList = new ArrayList<Bundle>(){{
            add(new Bundle("demo", false, "com.naruto.mobile.base.serviceaop.demo"));
            add(new Bundle("commonservice", false, "com.naruto.mobile.framework"));
            add(new Bundle("h5ServiceDemo", false, "com.naruto.mobile.h5container"));
            add(new Bundle("funccomponent", false, "com.naruto.mobile"));
            add(new Bundle("launcher", true, "com.naruto.mobile.applauncher"));
            add(new Bundle("app2Demo", false, "com.naruto.mobile.app2demo"));
        }};
        return bundleList;
    }
}
