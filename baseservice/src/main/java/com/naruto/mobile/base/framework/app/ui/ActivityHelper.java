...
//		AlipayApplication application = AlipayApplication.getInstance();
...
//		mMicroApplicationContext.saveState();
	...
	public <T extends ExternalService> T getExtServiceByInterface(
			String className) {
		return (T) NarutoApplication.getInstance().getNarutoApplicationContext().getExtServiceByInterface(className);
	}
