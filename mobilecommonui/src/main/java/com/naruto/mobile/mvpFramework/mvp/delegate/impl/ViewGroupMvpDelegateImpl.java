...
package com.naruto.mobile.mvpFramework.mvp.delegate.impl;
...
import com.naruto.mobile.mvpFramework.presentermanager.MosbySavedState;
import com.naruto.mobile.mvpFramework.presentermanager.PresenterManager;

/**
 * The mvp delegate used for everything that derives from {@link View} like {@link FrameLayout} etc.
 *
 * <p> The following methods must be called from the corresponding View lifecycle method: <ul> <li>{@link
 * #onAttachedToWindow()}</li> <li>{@link #onDetachedFromWindow()}</li> </ul> </p>
 *
...
public class ViewGroupMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
    ...
    /**
     * Generates the unique (mosby internal) viewState id and calls {@link MvpDelegateCallback#createPresenter()} to
