...
/**
 * A {@link LceViewState} and {@link RestorableViewState} that uses a <code>List<? extends Parcelable></code> containing
...
public class ParcelableListLceViewState<D extends List<? extends Parcelable>, V extends MvpLceView<D>>
    ...
    public static final Parcelable.Creator<ParcelableListLceViewState> CREATOR =
            new Parcelable.Creator<ParcelableListLceViewState>() {
                @Override
