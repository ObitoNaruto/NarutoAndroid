...
import com.naruto.mobile.mvpFramework.demo.mvp.customviewstate.MyCustomActivity;
import com.naruto.mobile.mvpFramework.demo.mvp.lce.activity.CountriesActivity;
import com.naruto.mobile.mvpFramework.demo.mvp.lce.layout.CountriesLayoutActivity;
import com.naruto.mobile.mvpFramework.demo.mvp.lce.viewpager.ViewPagerActivity;
import com.naruto.mobile.mvpFramework.demo.mvp.lce.viewstate.NotRetainingCountriesActivity;
import com.naruto.mobile.mvpFramework.demo.mvp.lce.viewstate.RetainingCountriesActivity;
import com.naruto.mobile.mvpFramework.demo.mvp.lce.viewstate.RetainingCountriesFragmentEmbededInXmlActivity;

import butterknife.BindView;
import butterknife.ButterKnife;


public class MvpDemoMainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private Demo[] createDemos() {
        return new Demo[]{
                ...
                new Demo("Simple LceFragment",
                        new Intent(this, FragmentContainerActivity.class).putExtra("fragment", "CountriesFragment")),
                new Demo("RetainingViewsState LceFragment", new Intent(this, FragmentContainerActivity.class)
                        .putExtra("fragment", "RetainingCountriesFragment")),
                new Demo("Retaining by using Parcelable ViewsState LceFragment",
                        new Intent(this, FragmentContainerActivity.class)
                                .putExtra("fragment", "NotRetainingCountriesFragment")),
                new Demo("Retaining ViewsState LceActivity", new Intent(this, RetainingCountriesActivity.class)),
