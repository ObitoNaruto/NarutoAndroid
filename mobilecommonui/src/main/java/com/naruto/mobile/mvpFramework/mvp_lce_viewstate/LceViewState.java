...
/**
 * An LCE (Loading-Content-Error) {@link ViewState} is a viewstate that can save and restore loading, the content, or
 * the error (exception).
 *
...
public interface LceViewState<D, V extends MvpLceView<D>> extends ViewState<V> {
    ...
    /**
     * Used as currentViewState to indicate that the content is currently displayed on screen
     */
