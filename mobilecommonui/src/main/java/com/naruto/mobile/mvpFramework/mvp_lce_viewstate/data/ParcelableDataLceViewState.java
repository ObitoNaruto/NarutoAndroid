...
package com.naruto.mobile.mvpFramework.mvp_lce_viewstate.data;

import android.os.Parcel;
import android.os.Parcelable;

import com.naruto.mobile.mvpFramework.mvp_lce.MvpLceView;
import com.naruto.mobile.mvpFramework.mvp_lce_viewstate.AbsParcelableLceViewState;
...
/**
 * A {@link LceViewState} and {@link RestorableViewState} that uses Parcelable as content data. Internally it uses
 * {@link Parcel#writeParcelable(Parcelable, int)} and {@link Parcel#readParcelable(ClassLoader)} for serialisation. It
 * uses the default class loader. You can override {@link #getClassLoader()} for provide your own ClassLoader.
 *
 * <p> Can be used for Activites and Fragments. </p>
 *
