...
/**
 * A {@link LceViewState} and {@link RestorableViewState} that uses ArrayList containing Parcelables as content data.
 * This class takes a <code>List<? extends Parcelable></code> but assumes that it is an instance of ArrayList. It uses
 * {@link Parcel#writeList(List)} and {@link Parcel#readArrayList(ClassLoader)} for serialisation <p> Can be used for
 * Activites and Fragments. </p>
 *
