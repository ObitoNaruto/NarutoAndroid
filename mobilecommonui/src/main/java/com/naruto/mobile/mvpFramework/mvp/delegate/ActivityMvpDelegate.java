...
package com.naruto.mobile.mvpFramework.mvp.delegate;
 ...
 *
 * <p> The following methods must be invoked from the corresponding Activities lifecycle methods: <ul> <li>{@link
 * #onCreate(Bundle)}</li> <li>{@link #onDestroy()}</li> <li>{@link #onPause()} </li> <li>{@link #onResume()} </li>
 * <li>{@link #onStart()} </li> <li>{@link #onStop()} </li> <li>{@link #onRestart()} </li> <li>{@link
 * #onContentChanged()} </li> <li>{@link #onSaveInstanceState(Bundle)} </li> <li>{@link #onPostCreate(Bundle)} </li>
 * <li></li> </ul> </p>
 *
...
public interface ActivityMvpDelegate<V extends MvpView, P extends MvpPresenter<V>> {
    ...
    /**
     * This method must be called from {@link Activity#onCreate(Bundle)}. This method internally creates the presenter
     * and attaches the view to it.
     */
    void onCreate(Bundle bundle);

    /**
     * This method must be called from {@link Activity#onDestroy()}}. This method internally detaches the view from
     * presenter
     */
    void onDestroy();
