...
public class LceAnimator {
    ...
    /**
     * Show the loading view. No animations, because sometimes loading things is pretty fast (i.e. retrieve data from
     * memory cache).
     */
    ...
    public static void showErrorView(@NonNull final View loadingView, @NonNull final View contentView,
        ...
        // Not visible yet, so animate the view in,1.0:完全不透明，0.0：完全透明
        AnimatorSet set = new AnimatorSet();
        ObjectAnimator in = ObjectAnimator.ofFloat(errorView, View.ALPHA, 1f);//由0->1
        ObjectAnimator loadingOut = ObjectAnimator.ofFloat(loadingView, View.ALPHA, 0f);//由1->0
