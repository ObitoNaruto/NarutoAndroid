...
public class ActivityMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
     ...
     * @param keepPresenterInstance true, if the presenter instance should be kept across screen orientation changes.
     *                              Otherwise false.
     */
    ...
    /**
     * Generates the unique (mosby internal) view id and calls {@link MvpDelegateCallback#createPresenter()} to create a
     * new presenter instance
     *
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (keepPresenterInstance && outState != null) {
            ...
            if (DEBUG) {
                Log.d(DEBUG_TAG,"Saving MosbyViewId into Bundle. ViewId: " + mosbyViewId + " for view " + getMvpView());
            }
        }
    }
