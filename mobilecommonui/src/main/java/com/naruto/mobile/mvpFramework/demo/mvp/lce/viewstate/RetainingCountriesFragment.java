...
/**
 * This is an example of a RETAINING Fragment. The viewstate will be kept in memory during screen orientation changes.
 *
 * @author xuxinming
 */
public class RetainingCountriesFragment extends
    ...
    public LceViewState<List<Country>, CountriesView> createViewState() {
        setRetainInstance(true);//这句代码是关键，是android原生支持的，调用后所有在onCreateView中创建的GUI被销毁，所有引用对象都将被存储
