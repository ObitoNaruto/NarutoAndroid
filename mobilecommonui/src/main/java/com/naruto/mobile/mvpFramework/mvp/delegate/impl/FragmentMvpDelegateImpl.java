...
public class FragmentMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
     ...
     * @param keepPresenterDuringScreenOrientationChange true, if the presenter should be kept during screen orientation
    ...
    private P createViewIdAndCreatePresenter() {
        ...
        if (keepPresenterInstanceDuringScreenOrientationChanges) {//缓存
