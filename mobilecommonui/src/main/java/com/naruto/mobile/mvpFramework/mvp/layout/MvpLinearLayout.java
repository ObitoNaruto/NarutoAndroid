...
package com.naruto.mobile.mvpFramework.mvp.layout;
...
import com.naruto.mobile.mvpFramework.mvp.delegate.impl.ViewGroupMvpDelegateImpl;
...
public abstract class MvpLinearLayout<V extends MvpView, P extends MvpPresenter<V>>
     ...
     * etc.
     *
     * <p><b>Please note that only one instance of mvp delegate should be used per android.view.View instance</b>. </p>
     *
