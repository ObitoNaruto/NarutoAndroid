...
/**
 * This class basically represents a Map for View Id to the Presenter / ViewState. One instance of this class is also
 * associated by {@link PresenterManager} to one Activity (kept across screen orientation changes)
 *
...
class ActivityScopedCache {
    ...
    */
     ...
     *
     * @param viewId    The mosby internal View id of the {@link MvpView} which the presenter is associated to.
